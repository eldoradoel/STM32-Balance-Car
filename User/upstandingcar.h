...
extern float Tracing_Speed,Tracing_Direction;
...
void ControlCarDoDemo2(void);
void SysTick_Handler_ForUpstandingCar(void);
float ControlCarDoDemoYaw(void);
float ControlCarDoDemoGetDiffAngle(void);
